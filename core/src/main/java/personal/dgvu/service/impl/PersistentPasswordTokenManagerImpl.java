...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see personal.dgvu.service.impl.PasswordTokenManager#generateRecoveryToken(personal.dgvu.model.User)
     */
    @Override
    ...
    /**
     * @see personal.dgvu.service.impl.PasswordTokenManager#isRecoveryTokenValid(personal.dgvu.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see personal.dgvu.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
